...
def extract_feature(net_name, model_name, name, blob_names, img_size = 227):
    ...
    for img in imgs:
        ...
        count += 1
    for i in xrange(len(blob_names)):
        f = open('/home/feiyu1990/local/event_curation/CNN_all_event/features/'+name+'_'+blob_names[i]+ net_name + '.cPickle','wb')
        cPickle.dump(features[i], f)
        f.close()
if __name__ == "__main__":
   # extract_feature('_ranking_sigmoid_l2_iter_60000','python_deploy_siamese_old.prototxt','test',['fc8_class'])
   # extract_feature('segment_iter_60000','python_deploy_siamese_old.prototxt','test',['fc8_multevent'])
    extract_feature('segment_iter_70000','python_deploy_siamese_old.prototxt','test',['fc8_multevent'])
   # extract_feature('segment_iter_90000','python_deploy_siamese_old.prototxt','test',['fc8_multevent'])
   # extract_feature('segment_2round_iter_750000','python_deploy_siamese_old.prototxt','test',['fc8_multevent'])
   # extract_feature('vgg_segment_iter_460000','training/deploy_allevent_vgg.prototxt','test',['fc8_multevent'],224)
   # extract_feature('vgg_segment_iter_90000','training/deploy_allevent_vgg.prototxt','test',['fc8_multevent'],224)
   # extract_feature('vgg_segment_iter_60000','training/deploy_allevent_vgg.prototxt','test',['fc8_multevent'],224)
   # extract_feature('vgg_segment_iter_70000','training/deploy_allevent_vgg.prototxt','test',['fc8_multevent'],224)
   # extract_feature('_iter_120000','python_deploy_siamese_old.prototxt','test',['fc8_multevent'])
   # extract_feature('_ranking_euclidean_lossweight_iter_50000', 'python_deploy_siamese_old.prototxt', 'test', ['fc8_class'])
